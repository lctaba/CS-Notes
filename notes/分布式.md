...
![img](https://upload-images.jianshu.io/upload_images/94053-556d3f6870da25e3.png?imageMogr2/auto-orient/strip|imageView2/2/format/webp)
...
- 如果一个提案获得了通过，但是提案的proposer还没accept就挂了，那么就会卡死。因此被拒绝的proposer可以以更大的序号提出提案。
- 活锁：如果每次机器的提案都不通过，都去增大序号重新提案，就会导致提案一直提出，但没有一个能通过，因此设置了随机等待时间。
- 机器数变化：机器的变化也作为提案提出，这样每台机器都能知晓机器数发生了变化。
